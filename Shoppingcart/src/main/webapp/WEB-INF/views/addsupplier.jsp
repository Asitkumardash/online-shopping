...
<div class="container">
     ...
     <form:form class="form-horizontal" action="${contextroot}/admin/savesupplier" method="POST" commandName="supplier">

    <form:hidden path="supid" class="form-control" value="${supplier.supid}" />
...
<div class="form-group">
  <form:label class="col-md-4 control-label" for="textinput" path="supname">supplier name</form:label>  
  <div class="col-md-4">
  <form:input id="textinput" name="textinput" type="text" path="supname" placeholder="" value="${supplier.supname}" class="form-control input-md" />
...
<div class="form-group">
  <form:label class="col-md-4 control-label"  for="textarea" path="supdescription">supplier description</form:label>
  <div class="col-md-4">                     
    <form:textarea class="form-control" id="textarea"  path="supdescription" value="${supplier.supdescription}" name="textarea" ></form:textarea>
  </div>
</div>
