	...
	<c:choose>
		<c:when test="${not empty cartItems }">
			...
			<div class="panel-body">
						...
						<c:forEach items="${cartItems}" var="cartItem">
							<tr>
									...
									<div class="col-md-8 col-sm-8 col-xs-8">
										...
										<div class="text-right">
											<a href="${contextPath}/user/wishlist/move/${cartItem.id}"
												...
												href="${contextroot}/user/cart/delete/${cartItem.id}"
								...
								<td><form:form method="POST"
										action="${contextroot}/user/cart/update"
				...
				<div class="text-right">
					<a href="${contextroot}/" class="btn-lg btn-default">< Continue
						Shopping</a> <a href="${contextroot}/addressList"
