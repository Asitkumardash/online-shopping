										    ...
										    <div class="thumbnail">
										      ...
										      <!-- 	<div class="caption"> -->
											        ...
											        <p>${addresses.pincode}</p>
		                                               ...
		                                               <a href="${contextroot}/user/updateAddresses/${addresses.addid}" class="btn btn-primary" >Edit</a>
		                                               <a href="${contextroot}/user/deleteAddresses/${addresses.addid}" class="btn btn-danger" >Remove</a>
